...
public partial class StockOrderPage : SfContentPage
{
    private readonly StockOrderViewModel _viewModel;
    protected override Type ViewModelType { get; set; } = typeof(StockOrderViewModel);
    public StockOrderPage(StockOrderViewModel viewModel)
	{
		InitializeComponent();
